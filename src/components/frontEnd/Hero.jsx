const Hero = () => {
    return (
      <div className="bg-[#E3EDF6] mt-4 container">
        <div className="container grid md:grid-cols-2 py-8">
          <div className="flex items-center">
            <div className="max-w-[450px] space-y-4">
              ...
              <h1 className="text-topHeading Primary font-bold text-4xl md:text-5xl">
          ...
          <div>
            <img className="ml-auto" src="images/hero.png" alt="hero" /> 
          </div>
        </div>
      </div>
    );
